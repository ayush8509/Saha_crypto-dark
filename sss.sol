...
contract SANTAWAR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SANTAWAR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7d051b95520c8E58edEf1228A4Bf53D4B6e7d87E;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        _balances[marketingFeeReceiver] = _balances[marketingFeeReceiver].add(marketingFeeAmount);
